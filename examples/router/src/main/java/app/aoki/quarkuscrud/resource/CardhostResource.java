...
/**
 * REST API for jsapdu-over-ip router Provides cardhost discovery and management per OpenAPI spec
 */
@Path("/api/cardhosts")
public class CardhostResource {
  ...
  /** List available cardhosts GET /api/cardhosts */
  @GET
  ...
  public Map<String, Object> listCardhosts(
    ...
    return Map.of("cardhosts", filteredCardhosts, "total", filteredCardhosts.size());
  }

  /** Get cardhost details by UUID GET /api/cardhosts/{uuid} */
  @GET
  @Path("/{uuid}")
  @Produces(MediaType.APPLICATION_JSON)
